...
namespace NeuralNetworkOld
{
    public class Layer
    {
        ...
        public NeuralNetwork Parent { get; set; }
        ...
        public void Create(NeuralNetwork parent, int nrOfOutputs)
        {
            Parent = parent;
        ...
        public void Create(NeuralNetwork parent, int nrOfOutputs, int nrOfInputs)
        {
            Parent = parent;
